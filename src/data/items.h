...
// Candy
    ...
    [ITEM_RARE_CANDY] =
    {
        ...
        .price = (I_PRICE >= GEN_7) ? 20000 : 20000,
        .description = COMPOUND_STRING(
            "Raises the level\n"
            "of a Pokémon by\n"
            "one."),
...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_FLING] =
    {
        ...
        .price = 1500,
        .description = COMPOUND_STRING(
            "Flings the held item\n"
            "to attack. Power depends\n"
            "on the item thrown."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TM_GYRO_BALL] =
    {
        ...
        .description = COMPOUND_STRING(
            "Spins fast. Power\n"
            "is higher the slower\n"
            "the user is than the foe."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
    ...
    [ITEM_TM_SMACK_DOWN] =
    {
        ...
        .price = 2000,
        .description = COMPOUND_STRING(
            "Throws a stone to hit\n"
            "flying targets. Knocks\n"
            "them to the ground."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TM_TRAILBLAZE] =
    {
        ...
        .price = 2000,
        .description = COMPOUND_STRING(
            "Attacks while pushing\n"
            "through lines. Raises\n"
            "the user's Speed."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
