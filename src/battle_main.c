...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_COOLTRAINER] = { _("COOLTRAINER"), 24, BALL_ULTRA },
    ...
    [TRAINER_CLASS_CHAMPION2] = { _("CHAMPION"), 50, BALL_ULTRA },
    ...
    [TRAINER_CLASS_DICTATOR] = { _("DICTATOR") },
    [TRAINER_CLASS_CUTETRAINER] = { _("CUTETRAINER") },
