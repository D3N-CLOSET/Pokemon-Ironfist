...
#define AI_FLAG_BASIC_TRAINER           (AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_TERA)
#define AI_FLAG_NON_SWITCHER            (AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY)
#define AI_FLAG_SMART_TRAINER           (AI_FLAG_BASIC_TRAINER | AI_FLAG_OMNISCIENT | AI_FLAG_PP_STALL_PREVENTION)
...
#define AI_FLAG_GYM_LEADER              (AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_NON_SWITCHER | AI_FLAG_PREDICTION | AI_FLAG_HP_AWARE | AI_FLAG_SMART_TERA | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY)
#define AI_FLAG_MAY_RIVAL               (AI_FLAG_BASIC_TRAINER | AI_FLAG_PREDICTION | AI_FLAG_RISKY)
#define AI_FLAG_WINONA_LEAD             (AI_FLAG_GYM_LEADER | AI_FLAG_RISKY)
#define AI_FLAG_SEMI_SMART_TRAINER      (AI_FLAG_BASIC_TRAINER | AI_FLAG_PREDICTION | AI_FLAG_ASSUMPTIONS | AI_FLAG_SMART_TERA)
#define AI_FLAG_SMART_TRAINER_DOUBLE    (AI_FLAG_SMART_TRAINER | AI_FLAG_DOUBLE_BATTLE)
#define AI_FLAG_GYM_LEADER_DOUBLE       (AI_FLAG_GYM_LEADER | AI_FLAG_DOUBLE_BATTLE)
