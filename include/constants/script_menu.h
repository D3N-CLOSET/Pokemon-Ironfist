...
enum
{
    ...
    MULTI_LINK_LEADER,
    MULTI_CONTEST_RANK,
    MULTI_CONTEST_RANK_FALLARBOR,
    MULTI_CONTEST_RANK_SLATEPORT,
    MULTI_CONTEST_RANK_VERDANTURF,
...
#define SSTIDAL_SELECTION_SILVER_ISLAND    6
#define SSTIDAL_SELECTION_SAGE_ISLAND      7
